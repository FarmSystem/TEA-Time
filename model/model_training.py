...
BATCH_SIZE = 512 # BATCH_SIZE 줄여서 그레이디언트 보다 정확하게 업데이트
NUM_EPOCHS = 10
...
kargs={
    ...
    'num_filters':100, # 합성곱 필터 수
    'dropout_rate':0.5, # 드롭아웃 비율
    'hidden_dimension':250, # 은닉층
...
class CNNClassifier(tf.keras.Model):
    ...
    def __init__(self, **kargs):
        ...
        self.fc2 = layers.Dense(units=kargs['output_dimension'],  # 수정할 부분 : 출력 차원 변경
                                ...
                                kernel_constraint= tf.keras.constraints.MaxNorm(max_value=3.)) # 가중치 제한 3 / 수정할 필요 있음
...
checkpoint_path = DATA_OUT + model_name + '\weights.h5' # 가중치 이름
